 ...
 * to ensure proper connections even when the browser attempts to connect to localhost
 */
...
(function() {
    ...
    // Patch the WebSocket constructor to redirect localhost to localhost
    window.WebSocket = function(url, protocols) {
        if (typeof url === 'string') {
            // Replace localhost with localhost in WebSocket URLs
    ...
    // Patch the location.hostname if it's localhost
